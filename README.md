...
> <!--致冷漠的学生们：-->上传者 @fjn308 以个人身份临时提醒：由于众所周知的原因，近期往 GitHub 上传大文件异常困难，白白浪费不少时间。考虑到即便我传上来可能你也不容易下得去，还是等六月份开完会再说吧。有强烈需求的同学们请暂时在另外两个平台凑合凑合将就将就，虽然我猜如果你真有强烈需求早就 Watch 并顺手 Star 了，然而并没有，所以本页面<!--不是-->意义甚微<!--而毫无意义-->，此事也不急。事情呢就是这么个事情，情况也就是这么个情况。不会烂尾，传完只是时间问题，“you have my word”。
...
建议使用 [7-Zip](https://www.7-zip.org/download.html) 解压压缩文件，使用 [MPC-HC](https://mpc-hc.org/downloads/) 播放视频文件。这里选择上传压缩文件而非视频文件是出于体积的考虑，选择 GitHub 作为发布平台是**为了尽可能地降低下载成本<!--原文：恶劣网络环境下的无奈之举-->**。每一次从录制到打包，我们都直接用到了以下工具：
