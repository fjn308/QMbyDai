...
建议使用 [7-Zip](https://www.7-zip.org/download.html) 解压压缩文件，使用 [MPC-HC](https://mpc-hc.org/downloads/) 播放视频文件。这里选择上传压缩包而非视频是出于体积的考虑，选择 GitHub 作为发布平台是**恶劣网络环境下的无奈之举**。科技在进步，文明在进步，传输一个文件却愈发艰难。这人为塑造的恶劣倒退了科技和文明，显得格外扎眼。基于此，下面的感谢是认真的——每一次从录制到打包，我们都直接用到了以下工具：
